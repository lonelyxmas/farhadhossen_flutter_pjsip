...
class FlutterPjsip {
  ...
  // static late FlutterPjsip _instance;
  //
  ...
  static FlutterPjsip _getInstance() {
    _instance ??= FlutterPjsip._internal();
    return _instance!;
  }
...
//    final remoteUri = callArgs['remote_uri'];
  ...
  ///pjsip登录
  Future<bool> pjsipLogin({required String username,required  String password,required  String ip,required  String port}) async {
